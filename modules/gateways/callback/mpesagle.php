...
$mpesagle = basename(__FILE__, '.php');

// Fetch gateway configuration parameters.
$gatewayParams = getGatewayVariables($mpesagle);
 ...
 */
$commandIdPay = $gatewayParams['commandIdPay'];
if ($hash != md5($invoiceId . $transactionId . $paymentAmount . $commandIdPay)) {
